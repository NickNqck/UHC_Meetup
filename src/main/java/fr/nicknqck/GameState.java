...
public class GameState{
	...
	public RoleBase GiveRole(Player aziz) {
        ...
        if (roleType instanceof Roles) {
            switch((Roles)(roleType)) {
                case Muzan:
	...
	public void print(@NonNull final UUID uuid,@NonNull final RoleBase role) {
		...
		if (player != null){
			...
			System.out.println(role.getOriginTeam().name()+" for role "+role.getRoles());
