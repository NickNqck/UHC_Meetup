...
public class MahrsConfig
extends ConfiguratorRole {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if (!item.isSimilar(GUIItems.getSelectBackMenu())) {
            ...
            if (!item.isSimilar(GUIItems.getSBluetainedGlassPane()) &&!item.isSimilar(GUIItems.getCantStartGameButton()) && !item.isSimilar(GUIItems.getStartGameButton())) {
