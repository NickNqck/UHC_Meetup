...
public enum Roles implements IRoles<Roles> {
    ...
    Kaigaku(TeamList.Demon, "ds", 9, new ItemBuilder(Material.YELLOW_FLOWER).setName("§cKaigaku").toItemStack(), "§bByC3RV0L3NT"),
    Enmu(TeamList.Demon, "ds", 10, new ItemBuilder(Material.EYE_OF_ENDER).setName("§cEnmu").toItemStack(), "§bNickNqck"),
    Rui(TeamList.Demon, "ds", 11, new ItemBuilder(Material.STRING).setName("§cRui").toItemStack(), "§bNickNqck"),
    Kyogai(TeamList.Demon, "ds", 12, new ItemBuilder(Material.DISPENSER).setName("§cKyogai").toItemStack(), "§bNickNqck"),
    ...
    Jean(TeamList.Soldat, "aot", 5, new ItemBuilder(Material.FIREWORK).setName("§aJean").toItemStack(), "§bNickNqck"),
    Onyankopon(TeamList.Soldat, "aot", 6, new ItemBuilder(Material.ENDER_PEARL).setName("§aOnyankopon").toItemStack(), "§bNickNqck"),
    ...
    Conny(TeamList.Soldat, "aot", 9, new ItemBuilder(Material.SUGAR_CANE).setName("§aConny").toItemStack(), "§bNickNqck"),
    ...
    ZetsuNoir(TeamList.Akatsuki, "ns", 9, new ItemBuilder(Material.INK_SACK).setName("§cZetsu Noir").toItemStack(), "§bNickNqck"),
    ZetsuBlanc(TeamList.Akatsuki, "ns", 10, new ItemBuilder(Material.BONE).setName("§cZetsu Blanc").toItemStack(), "§bNickNqck"),
    Sasori(TeamList.Akatsuki, "ns", 12, new ItemBuilder(Material.ARMOR_STAND).setName("§cSasori").toItemStack(), "§bNickNqck"),
    //Shinobi
    ...
    Hiruzen(TeamList.Shinobi, "ns", 21, new ItemBuilder(Material.DIRT).setName("§aHiruzen").toItemStack(), "§bByC3RV0L3NT"),
    Choji(TeamList.Shinobi, "ns", 22, new ItemBuilder(Material.CARROT_ITEM).setName("§aChoji").toItemStack(), "§bNickNqck"),
    //Haku et Zabuza
